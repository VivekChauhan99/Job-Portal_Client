...
const ManageJobs = () => {
    const {
        ...
        queryFn: () =>
            getAllHandler(
                `https://job-portal-server-eight.vercel.app/api/v1/jobs/my-jobs`
            ),
    });
    ...
    const deleteJobHandler = async (id) => {
        try {
            const response = await axios.delete(
                `https://job-portal-server-eight.vercel.app/api/v1/jobs/${id}`,
            ...
            // setJobs(updateJobs);
            // handleJobFetch(
            //     `https://job-portal-server-eight.vercel.app/api/v1/jobs?page=1`
            // );
            refetch();
            Swal.fire({
                title: "Deleted!",
